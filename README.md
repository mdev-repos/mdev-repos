...
<div style="display: flex; justify-content: center; gap: 30px; flex-wrap: wrap; margin-top: 20px;">
  ...
  <div style="border: 1px solid #9b9898; border-radius: 20px; padding: 15px; width: 300px; text-align: center; box-shadow: 3px 3px 2px #9b9898;">
    <img src="./assets/Nativo-01.png" alt="Nativo Banca Rural" style="width: 200px; height: auto; border-radius: 12px;">
  ...
  ### ECO Sistema
  <div style="border: 1px solid #9b9898; border-radius: 20px; padding: 15px; width: 300px; text-align: center; box-shadow: 3px 3px 2px #9b9898;">
    <img src="./assets/ECOSistema-00.png" alt="ECO Sistema" style="width: 200px; height: auto; border-radius: 12px;">
    <div style="display: flex; justify-content: space-around; margin-top: 10px;">

      ...
      <td>
        <div style="border: 0px; border-radius: 10px; padding: 20px; width: 250px; text-align: center;">
          ...
          <a href="https://github.com/igrowker/i003-nativo-back">
            <img src="https://github.com/mdev-repos/mdev-repos/blob/main/assets/Nativo-01.png" alt="Nativo Banca Rural" style="width: 200px; height: 200px; object-fit: cover; border-radius: 10px;">
          </a>
          <br/><br/>
          <a href="https://github.com/igrowker/i003-nativo-back">
      ...
      <td>
        <div style="border: 0px; border-radius: 10px; padding: 20px; width: 250px; text-align: center;">
          ...
          <a href="https://github.com/mdev-repos/EcoSistema-WebApp-v01">
            <img src="https://github.com/mdev-repos/mdev-repos/blob/main/assets/ECOSistema-00.png" alt="ECO Sistema" style="width: 200px; height: 200px; object-fit: cover; border-radius: 10px;">
          </a>
          <br/><br/>
          <a href="https://github.com/mdev-repos/EcoSistema-WebApp-v01">
            <img src="https://img.shields.io/badge/GitHub%20Repo-FF5722?style=flat-square&logo=github&logoColor=white" alt="GitHub Repo" />
